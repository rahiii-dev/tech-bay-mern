...
const Header = () => {
    ...
    return (
        <header className="shadow-sm w-screen overflow-y-hidden">
            <div className="container py-3 flex items-center gap-3">
                <div className="min-w-[100px]">
                    <img className="w-full h-auto object-contain" src={theme === 'light' ? LOGO_BLACK : LOGO_WHITE} alt="logo" />
                </div>

                <nav className="h-full flex transition-all duration-300">
                ...
                <div className="flex-grow flex justify-between items-center">
                    <div className="bg-secondary flex-grow max-w-[500px] relative rounded-full overflow-hidden">
                    ...
                    <nav className="h-full flex gap-2">
