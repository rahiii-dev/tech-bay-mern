            ...
            <section>
                ...
                <div className="mt-8 py-4 bg-black">
                    ...
                    {/* <div className="container flex items-center justify-between">
                        <img src="/user/brands/img-1.png" alt="brand-img" />
                        <img src="/user/brands/img-2.png" alt="brand-img" />
                        <img src="/user/brands/img-3.png" alt="brand-img" />
                        <img src="/user/brands/img-4.png" alt="brand-img" />
                        <img src="/user/brands/img-5.png" alt="brand-img" />
                    </div> */}
                </div>
            </section>
            ...
            <section className="pb-16">
                <div className="container bg-gray-200 rounded-2xl py-10 px-8">
                    ...
                    <div className="flex gap-4 mb-4">
                        <Link to={'laptops'} className="w-full max-w-[300px] h-[250px] hover:scale-[1.05] transition-all">
                        ...
                        <Link to={'laptops'} className="w-full flex-grow h-[250px] hover:scale-[1.05] transition-all">
                            <div className="relative w-full h-full p-4 bg-primary-foreground rounded-2xl overflow-hidden">
